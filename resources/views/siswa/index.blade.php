        ...
        <div class="col-md-6 col-lg-12 mb-3">
            <div class="card h-100">
                <div class="card-header text-center pb-0 mb-3">
                    <h5 class="card-title float-inline">Data Siswa</h5>
...
@section('page-script')
    ...
    <script type="text/javascript">
        ...
        function read() {
            $.get("{{ url('/siswa/read') }}", {}, function(kelas, status) {
                $("#read").html(kelas);
            });
        }
        ...
        {
            $.get(`{{ url('/siswa/show/${id}') }}`, {}, function(kelas, status) {
                $('#exampleModalLabel').html('Detail Siswa')
                $("#data-modal-siswa").html(kelas);
                $('#exampleModal').modal('show');
            });
        }
